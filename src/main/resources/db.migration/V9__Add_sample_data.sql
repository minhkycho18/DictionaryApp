INSERT INTO vocab_note.users (name, email, gender, password, image, role_id, is_lock, created_at)
VALUES ('learner1', 'learner1@gmail.com', 'MALE', '$2a$10$shVGSEIJpLjVaJfAzCSuEOkuow/2bGHFwCedSz0O5TQx9xrR0PDte', null,
        3, false, '2023-12-11 22:10:26'),
       ('learner2', 'learner2@gmail.com', 'MALE', '$2a$10$jxDjHmsxdpQswfyY8p/ng.DCBSk0FkM91AnCjHjtF.7SY/kLkWZ9y', null,
        3, false, '2023-01-02 23:12:26'),
       ('learner3', 'learner3@gmail.com', 'MALE', '$2a$10$GRcZUArt6MJG7x/h0IDvcOXX7cclgg.p1J1Ti0n8KXzQTascIN40m', null,
        3, false, '2021-07-19 07:10:16'),
       ('manager1', 'manager1@gmail.com', 'MALE', '$2a$10$dTU9CRTn4o/p3i.8XMvL3u83eJ2WK01CyMOQL.BIa/m1mLJDxi6ny', null,
        2, false, '2022-10-22 09:22:33'),
       ('manager2', 'manager2@gmail.com', 'MALE', '$2a$10$wINRTYNEA4nsAnWInBeuMuo1lJ.T6/VwVBTCQUd1QvpMDcytjk0YG', null,
        2, false, '2022-11-22 15:36:11'),
       ('admin', 'admin@gmail.com', 'MALE', '$2a$10$0NWBdd2x3m7rEk..5B9Lt.xj3aqnfiLgdtjNP8T2zO3CHTnIf6lfu', null, 1,
        false, '2021-04-26 12:10:26');

INSERT INTO vocab_note.word_list (word_list_id, title, list_desc, user_id, list_type, created_at)
VALUES (1, 'wordlist1', 'wordlist1', 1, 'PUBLIC', '2023-10-10 16:02:22'),
...
VALUES (1, 'subcategory1', 20, 'DEFAULT', 1),
...
INSERT INTO vocab_note.subcategory_detail (vocab_id, def_id, subcategory_id, is_quiz, is_review, is_flashcard,
                                           last_learning)
VALUES (7387, 23160, 2, 0, 1, 0, null),

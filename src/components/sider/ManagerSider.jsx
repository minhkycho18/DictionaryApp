...
import {AudioOutlined, FolderOutlined, LogoutOutlined, UserOutlined, VideoCameraOutlined} from '@ant-design/icons';
...
const Manager = () => {
    ...
    const items = dashboardManagerLink.map((item, index) => ({
        key: item.path,
        icon: item.icon,
        label: item.label,
    }));
        ...
        >
            ...
            >
                ...
                <div className={"sidebar__logout"}>
                    <Button onClick={handleSignOut} shape={"square"} className={"sidebar__logout_button"}>

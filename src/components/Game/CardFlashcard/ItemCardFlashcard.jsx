...
export default function ItemCardFlashcard({onNextSlider}) {
        ...
        <>
            ...
            >
                ...
                <View style={Styles.cardBack}>
                    ...
                    <TouchableOpacity style={Styles.back} onPress={() => setIsFlip(false)}>
                        <SvgXml style={{ right: '15%' }} width="27" height="27" xml={incorrect_correct_back.back} />
                    </TouchableOpacity>
                    ...
                    <View style={Styles.ConfirmButton} >
                        ...
                        >
                            ...
                            >
                                <SvgXml width="30" height="30" xml={incorrect_correct_back.incorrect} />
                            </View>
                            <Text
                                style={{
                                    fontSize: 17,
                        ...
                        >
                            ...
                            >
                                <SvgXml width="26" height="26" xml={incorrect_correct_back.correct} />
                            </View>
                            <Text
                                style={{
                                    fontSize: 17,

...
const VocabularyDataTable = ({loading, currentPage, pagination, dataSource, onTableChange, onClickItem}) => {
        ...
        },
        {
            ...
            render: () =>
                <Space size={"middle"}>
                    ...
                    <DeleteTwoTone twoToneColor="#EB1B36" className="function-box__delete"
        ...
        <>
            ...
            <Modal
                ...
                footer={[
                    ...
                    <Button key="submit" type="primary" danger onClick={handleDeleteVocab}>
                        Delete
                    </Button>
                ]}>
